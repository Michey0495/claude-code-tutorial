...
const TUTORIALS = {
    intro: [
        ...
        },
        {
            ...
            description: "Opus 5 / Sonnet 5 / Fable 5 / Haiku 4.5の性能差、1Mトークンコンテキスト、v2.1.233までの新機能群を把握する。",
            description_en: "Understand Opus 5 / Sonnet 5 / Fable 5 / Haiku 4.5 performance differences, 1M token context, and new features up to v2.1.233.",
            icon: "zap",
            tags: ["2026年8月最新", "モデル", "v2.1.233"],
            tags_en: ["August 2026 Latest", "Models", "v2.1.233"],
            content: {
                summary: "2026年8月時点でClaude Codeはv2.1.233（2026/8/14リリース）。モデル構成はOpus 5（v2.1.219でデフォルトに、複雑なエージェントコーディング・企業業務向け、1Mコンテキスト・128K最大出力、$5/$25 per MTok）、Sonnet 5（速度と知性のバランスが良く日常向き、1Mコンテキスト、$3/$15 per MTok・2026/8/31まで$2/$10の導入価格）、Fable 5（2026/6/9 GA、最も高性能な一般公開モデル、Adaptive Thinking常時有効）、Haiku 4.5（200kコンテキスト、軽量高速）。Opus 5・Sonnet 5はAdaptive Thinking対応でeffort既定はhigh（/effort xhighでさらに強化）。Opus 4.8以前はレガシー扱いで、Opus 4.1は2026/8/5に退役。コマンド面ではv2.1.202で/doctor（セットアップチェックアップ）、v2.1.198で/dataviz（チャート設計ガイダンス）が追加。v2.1.200では権限モード名称が「Default」→「Manual」に変更。v2.1.198でサブエージェントがデフォルトでバックグラウンド実行に。v2.1.207ではBedrock/Vertex/Foundryでのauto modeがopt-in不要に。v2.1.210ではWrite(path)/NotebookEdit(path)/Glob(path)権限ルールが廃止（Edit/Read使用）。v2.1.212では/subtask・/forkのバックグラウンド複製、v2.1.219でOpus 5がデフォルトになった。2026年8月の主要追加（v2.1.220〜v2.1.233）：セッション間メッセージング（macOS/Linux）、セルフホスト環境パブリックβ（Team/Enterprise）、auto modeがPro/Max/Teamの新規セッションでデフォルトに（2026/8/14〜）、/teleportコマンド（クラウドセッションをローカルへ転送）、--forward-subagent-text・--permission-prompt-toolフラグ、CLAUDE_CODE_ENABLE_TODO_TOOLS=1（新モデルでTodoツールが廃止されたため再有効化用）、Bash入力リダイレクト権限チェック（v2.1.233）、サブエージェント制御の新環境変数群（CLAUDE_CODE_MAX_SUBAGENTS_PER_SESSION等）、VS Code FocusビューがWeek 32で追加。",
                summary_en: "As of August 2026, Claude Code is at v2.1.233 (released 2026/8/14). Model lineup: Opus 5 (default since v2.1.219, for complex agentic coding and enterprise work, 1M context, 128k max output, $5/$25 per MTok), Sonnet 5 (best speed/intelligence balance for daily work, 1M context, $3/$15 per MTok with introductory $2/$10 until 2026/8/31), Fable 5 (GA 2026/6/9, most capable widely released model, Adaptive Thinking always on), Haiku 4.5 (200k context, lightweight). Opus 5 and Sonnet 5 support Adaptive Thinking with effort defaulting to high. Opus 4.8 and earlier are legacy; Opus 4.1 retires 2026/8/5. Key additions in v2.1.220–v2.1.233: cross-session messaging (macOS/Linux), self-hosted environments in public beta (Team/Enterprise), auto mode now the default for new sessions on Pro/Max/Team (from 2026/8/14), /teleport command (transfer cloud sessions to local), --forward-subagent-text and --permission-prompt-tool flags, CLAUDE_CODE_ENABLE_TODO_TOOLS=1 (todo tools removed from newer models), Bash input-redirection permission checks (v2.1.233), new subagent-control env vars (CLAUDE_CODE_MAX_SUBAGENTS_PER_SESSION etc.), Ultraplan removed (v2.1.221), VS Code Focus view (Week 32).",
                keyPoints: [
                    ...
                    "v2.1.220〜v2.1.233の主要新機能: セッション間メッセージング（macOS/Linux）、セルフホスト環境β（Team/Enterprise）、auto modeがPro/Max/Teamでデフォルトに（2026/8/14〜）、/teleport、--forward-subagent-text、CLAUDE_CODE_ENABLE_TODO_TOOLS=1、CLAUDE_CODE_MAX_SUBAGENTS_PER_SESSION等の制御環境変数、Ultraplan廃止（v2.1.221）"
                ],
                keyPoints_en: [
                    ...
                    "v2.1.220–v2.1.233 highlights: cross-session messaging (macOS/Linux), self-hosted environments beta (Team/Enterprise), auto mode default on Pro/Max/Team (from 2026/8/14), /teleport, --forward-subagent-text, CLAUDE_CODE_ENABLE_TODO_TOOLS=1, subagent control env vars, Ultraplan removed (v2.1.221)"
                ],
                newFeatures: [
...
const FAQ = [
    ...
    },
    {
        ...
        category: "設定",
        category_en: "Configuration",
        question: "配布されている設定テンプレートは商用利用できますか？",
        question_en: "Can the distributed configuration templates be used commercially?",
        answer: "配布 ZIP 30 本の内訳は、MIT / Apache-2.0 / MIT-0 の OSS が 25 本、本研修のためにギブリーが作成したものが 2 本、ライセンス表記のないものが 2 本、原典が全権利留保のため配布を止めたものが 1 本です。OSS の 25 本は、著作権表示とライセンス本文を残したまま使う限り、社内業務でも受託開発でも利用できます。ZIP には原典の LICENSE ファイルをそのまま同梱しています。Apache-2.0 のものを改変して配布する場合は、変更した旨をファイルに記載してください。ライセンス表記のない 2 本は権利者が利用条件を示していないため、社外に出す成果物へ組み込む前に原典リポジトリでご確認ください。各テンプレートのライセンスと権利者は「設定テンプレート」のカードに表示しています。",
        answer_en: "Of the 30 ZIP packages, 25 are open source under MIT, Apache-2.0, or MIT-0; 2 were created by Givery for this training; 2 state no license; and 1 was withdrawn because the original is all rights reserved. The 25 open-source packages can be used for internal work and client projects as long as you keep the copyright notice and license text - each ZIP ships with the original LICENSE file. For Apache-2.0 packages, state your changes in the files when you distribute a modified version. The 2 packages with no license state no terms of use, so check with the author before shipping them in work that leaves your company. Each card in the Configuration Templates section shows its license and copyright holder.",
        relatedTutorial: "01_01"
    }
];
...
const SETTINGS_TEMPLATES = [
    ...
    { id: 'claude-config-bundle', cat: 'official', title: '推奨 .claude/ 設定一式',
      ...
      license: '', holder: '株式会社ギブリー', licenseFlag: 'own' },
    { id: 'claude-code-official-plugins', cat: 'official', title: 'Claude Code 公式プラグイン パック',
      ...
      license: 'Apache-2.0', holder: 'Anthropic', source: 'https://github.com/anthropics/claude-code' },
    { id: 'aidriven-docs-commands', cat: 'official', title: 'AI 駆動 ドキュメント＆コマンド',
      ...
      license: 'MIT', holder: 'README に MIT と明記（権利者名の記載なし）' },
    ...
    { id: 'hallmark-ja', cat: 'official', title: 'Hallmark-JA プラグイン',
      ...
      license: 'MIT', holder: 'Hallmark contributors' },
    ...
    { id: 'cc-sdd', cat: 'workflow', title: 'cc-sdd（Spec Driven Development）',
      ...
      license: 'MIT', holder: 'gotalab', source: 'https://github.com/gotalab/cc-sdd' },
    { id: 'claude-code-spec-workflow', cat: 'workflow', title: 'claude-code-spec-workflow（Pimzino）',
      ...
      license: 'MIT', holder: 'Pimzino', source: 'https://github.com/pimzino/claude-code-spec-workflow' },
    { id: 'claude-code-starter-kit', cat: 'workflow', title: 'Claude Code Starter Kit',
      ...
      license: 'MIT', holder: 'CloudNative Inc.', source: 'https://github.com/cloudnative-co/claude-code-starter-kit' },
    { id: 'aidlc-workflows', cat: 'workflow', title: 'AWS AI-DLC ワークフロー',
      ...
      license: 'MIT-0', holder: 'Amazon.com, Inc.' },
    { id: 'spec-kit', cat: 'workflow', title: 'GitHub Spec Kit',
      ...
      license: 'MIT', holder: 'GitHub, Inc.', source: 'https://github.com/github/spec-kit' },
    ...
    { id: 'everything-claude-code', cat: 'reference', title: 'Everything Claude Code（総合カタログ）',
      ...
      license: 'MIT', holder: 'Affaan Mustafa' },
    ...
    { id: 'awesome-claude-skills', cat: 'skills', title: 'Awesome Claude Skills（Composio）',
      ...
      license: 'Apache-2.0', holder: 'Composio ほか（同梱の Anthropic 製 Skill も Apache-2.0）' },
    { id: 'claude-skills', cat: 'skills', title: 'claude-skills（trkbt10 / Office系）',
      ...
      license: 'MIT', holder: 'trkbt10（marketplace.json に記載。LICENSE ファイルは同梱なし）' },
    ...
    { id: 'claude-code-skill-example', cat: 'skills', title: 'Skill 最小例（plan→worktree→PR）',
      ...
      license: '', holder: '原典リポジトリの作者', licenseFlag: 'unknown' },
    { id: 'site2skill', cat: 'skills', title: 'site2skill（ドキュサイト→Skill変換）',
      ...
      license: 'MIT', holder: 'laiso', source: 'https://github.com/laiso/site2skill' },
    { id: 'opc-skills', cat: 'skills', title: 'opc-skills（ReScienceLab）',
      ...
      license: 'Apache-2.0', holder: 'ReScienceLab', source: 'https://github.com/ReScienceLab/opc-skills' },
    { id: 'obsidian-dev-skills', cat: 'skills', title: 'Obsidian Dev Skills',
      ...
      license: 'MIT', holder: 'David V. Kimball' },
    { id: 'skills', cat: 'skills', title: '逆瀬川氏（@gyakuse）個人スキル保管庫',
      ...
      license: 'MIT', holder: 'Sakasegawa（@gyakuse）' },
    { id: 'pm-skills', cat: 'skills', title: 'pm-skills（PM 用 65 + 36）',
      ...
      license: 'MIT', holder: 'Pawel Huryn' },
    { id: 'miyabi-claude-plugins', cat: 'skills', title: 'miyabi-claude-plugins',
      ...
      license: 'MIT', holder: 'Shunsuke Hayashi / 合同会社みやび', source: 'https://github.com/ShunsukeHayashi/miyabi-claude-plugins' },
    { id: 'notebooklm-skill', cat: 'skills', title: 'NotebookLM 連携 Skill',
      ...
      license: 'MIT', holder: 'Please Prompto!', source: 'https://github.com/PleasePrompto/notebooklm-skill' },
    ...
    { id: 'claude-agents', cat: 'agents', title: 'Claude Agents（arian88・専門領域別）',
      ...
      license: '', holder: 'arian88', source: 'https://github.com/arian88/claude-agents', licenseFlag: 'unknown' },
    { id: 'claude-agents-main', cat: 'agents', title: 'Claude Agents（main.zip / リリース版）',
      ...
      license: 'MIT', holder: 'ian nuttall' },
    ...
    { id: 'ui-ux-pro-max-skill', cat: 'design', title: 'UI/UX Pro Max Skill',
      ...
      license: 'MIT', holder: 'Next Level Builder' },
    { id: 'claude-design-skill', cat: 'design', title: 'claude-design-skill（Interface Design）',
      ...
      license: 'MIT', holder: 'Damola Akinleye', source: 'https://github.com/Dammyjay93/interface-design' },
