...
(function() {
    ...
    const i18n = {
        ja: {
            ...
            heroDesc: 'エージェント型AIコーディングの真髄を学ぶ。<br>公式ベストプラクティスに基づいた全50章 + 13種類のハンズオン。<br><span style="font-size:0.85em;opacity:0.8;">2026年8月最新版 / Opus 5 / Sonnet 5 / Fable 5 / v2.1.233対応</span>',
        ...
        en: {
            ...
            heroDesc: 'Master agent-based AI coding.<br>50 chapters + 13 hands-on exercises based on official best practices.<br><span style="font-size:0.85em;opacity:0.8;">August 2026 / Opus 5 / Sonnet 5 / Fable 5 / v2.1.233</span>',
