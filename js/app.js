...
(function() {
    ...
    const i18n = {
        ja: {
            ...
            heroDesc: 'エージェント型AIコーディングの真髄を学ぶ。<br>公式ベストプラクティスに基づいた全50章 + 13種類のハンズオン。<br><span style="font-size:0.85em;opacity:0.8;">2026年7月最新版 / Fable 5 / Opus 4.8 / Sonnet 5 / Haiku 4.5 / v2.1.197対応</span>',
        ...
        en: {
            ...
            heroDesc: 'Master agent-based AI coding.<br>50 chapters + 13 hands-on exercises based on official best practices.<br><span style="font-size:0.85em;opacity:0.8;">July 2026 / Fable 5 / Opus 4.8 / Sonnet 5 / Haiku 4.5 / v2.1.197</span>',
