...
(function() {
    ...
    const i18n = {
        ja: {
            ...
            heroDesc: 'エージェント型AIコーディングの真髄を学ぶ。<br>公式ベストプラクティスに基づいた全40章 + 13種類のハンズオン。<br><span style="font-size:0.85em;opacity:0.8;">2026年3月最新版 / Opus 4.6 / Sonnet 4.6 / Haiku 4.5 / v2.1対応</span>',
        ...
        en: {
            ...
            heroDesc: 'Master agent-based AI coding.<br>40 chapters + 13 hands-on exercises based on official best practices.<br><span style="font-size:0.85em;opacity:0.8;">March 2026 / Opus 4.6 / Sonnet 4.6 / Haiku 4.5 / v2.1</span>',
