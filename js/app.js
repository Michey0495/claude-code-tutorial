...
(function() {
    ...
    const i18n = {
        ja: {
            ...
            heroDesc: 'エージェント型AIコーディングの真髄を学ぶ。<br>公式ベストプラクティスに基づいた全40章 + 13種類のハンズオン。<br><span style="font-size:0.85em;opacity:0.8;">2026年5月最新版 / Opus 4.7 / Sonnet 4.6 / Haiku 4.5 / v2.1.132対応</span>',
        ...
        en: {
            ...
            heroDesc: 'Master agent-based AI coding.<br>40 chapters + 13 hands-on exercises based on official best practices.<br><span style="font-size:0.85em;opacity:0.8;">May 2026 / Opus 4.7 / Sonnet 4.6 / Haiku 4.5 / v2.1.132</span>',
